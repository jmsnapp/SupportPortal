...
Data Type: bigint  
Allow Nulls: No  
Required: Autogenerated.  Seed is 0.  
...
Required:  No  
This field is meant for a description that would appear in the user interface for this item.  The default is an empty string.
...
Data Type: datetime  
Allow Nulls: Yes  
Default Value:  '1/1/1900 00:00:00.000'
Required:  Yes  
...
Allow Nulls: No  
Required: Yes  
This field contains the date and time that the integration error occurred.
...
Data Type: datetime  
Allow Nulls: Yes  
Default Value: '1/1/1900 00.00.0000'
Required: No  
...
Data Type: datetime  
Allow Nulls: No  
Default Value: '01/01/1900 00:00:00.000'
Required: Yes  
