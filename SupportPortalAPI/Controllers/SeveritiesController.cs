...
{
    public class SeveritiesController : GenericController<Severity, Severity, SeverityEntity>
    {
        public SeveritiesController(IGenericRepository<Severity, Severity, SeverityEntity> repo, IOptions<PaginationOptions>? options = null) : base(repo, options) { }
