...
{
    public class PhasesController : GenericController<Phase, Phase, PhaseEntity>
    {
        public PhasesController(IGenericRepository<Phase, Phase, PhaseEntity> repo, IOptions<PaginationOptions>? options = null) : base(repo, options) { }
