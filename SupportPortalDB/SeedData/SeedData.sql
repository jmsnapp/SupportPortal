...
INSERT INTO [dbo].[Customers]([Name], [Description], [IndustryId], [PrimaryContactName], [PrimaryContactEmail], [TechnicalContactName], [TechnicalContactEmail], [CreatedDate])
	VALUES ('DEFAULT', 'Default Customer', 0, 'Default', 'default@noemail.com', 'Default', 'default@noemail.com', GETDATE());
INSERT INTO [dbo].[Customers]([Name], [Description], [IndustryId], [PrimaryContactName], [PrimaryContactEmail], [TechnicalContactName], [TechnicalContactEmail], [CreatedDate])
...
-- Tertiary Tables
INSERT INTO [dbo].[Integrations]([Name], [Description], [CustomerId], [IntegrationTypeId], [CurrentStatusId])
...
INSERT INTO [dbo].[Projects]([Name], [Description], [CustomerId], [CurrentPhase])
...
INSERT INTO [dbo].[ProjectNotes]([Name], [Description], [ProjectId])
...
INSERT INTO [dbo].[Escalations]([Name], [Description], [ProblemSummary], [CustomerImpact], [RootCause], [RecommendedActions])
...
INSERT INTO [dbo].[Tickets]([Name], [Description], [CustomerId], [IntegrationId], [Reproduce], [SeverityId], [StatusId], [ReportedBy], [AssignedTo], [CreatedDate], [ResolutionDate], [Resolution], [EscalationId])
	...
	(SELECT [Id] FROM [dbo].[Escalations] WHERE [Name] = 'DEFAULT'));
INSERT INTO [dbo].[Tickets]([Name], [Description], [CustomerId], [IntegrationId], [Reproduce], [SeverityId], [StatusId], [ReportedBy], [AssignedTo], [CreatedDate], [ResolutionDate], [Resolution], [EscalationId])
...
INSERT INTO [dbo].[TicketNote]([Name], [Description], [TicketId])
	VALUES(0, 'Default Note', 0);
