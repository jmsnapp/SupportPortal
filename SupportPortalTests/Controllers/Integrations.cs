...
public class IntegrationsControllerTests
{
    ...
    public async Task GetAll_ReturnsMappedList()
    {
        ...
        ActionResult<PagedResult<Integration>> result = await controller.GetAll();

        PagedResult<Integration> page = result.Value!;
    ...
    public async Task GetAllActive_ReturnsMappedList()
    {
        ...
        ActionResult<PagedResult<Integration>> result = await controller.GetAllActive();
